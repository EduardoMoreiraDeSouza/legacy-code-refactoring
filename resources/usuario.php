    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php } ?>
                <form class="form-horizontal form-material" action="<?php echo BASE_URL; ?>/cad-usuario" method="POST"
                      autocomplete="off">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="col-md-12 border-bottom p-0">
                            <input type="text" placeholder="Paul" name="login" class="form-control p-0 border-0"
                                   id="login" value="<?= $old['login']; ?>">
                        </div>
                    </div>
                    <div class="form-group mb-4">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="col-md-12 border-bottom p-0" for="telefone">
                            <input type="text" placeholder="(99) 99999-9999" name="telefone" id="telefone"
                                   class="form-control p-0 border-0" value="<?= $old['telefone']; ?>">
                        </div>
                    </div>
